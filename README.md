...
1.  Check to see if [vpnkit-controller](https://www.docker.com/blog/how-kubernetes-works-under-the-hood-with-docker-desktop/) is installed `kubectl get pods -n kube-system`  
1.  Review your hosts file `"C:\Windows\System32\drivers\etc\hosts"`
